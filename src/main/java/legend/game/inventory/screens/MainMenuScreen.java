...
public class MainMenuScreen extends MenuScreen {
  ...
  private StatisticsScreen showStatisticsScreen() {
    return this.showScreen(StatisticsScreen::new);
  }

  private BestiaryScreen showBestiaryScreen() {
    return this.showScreen(BestiaryScreen::new);
  }
