        ...
        if(fullScreenEffect_800bb140.currentColour_28 == 0) {
          ...
          for(int charSlot = 0; charSlot < gameState_800babc8.charIds_88.size(); charSlot++) {
            if(this.characterIsAlive(charSlot)) {
              ...
              Statistics.appendStat(gameState_800babc8.charIds_88.getInt(charSlot), Statistics.Stats.TOTAL_EXP, this.pendingXp_8011e180[gameState_800babc8.charIds_88.getInt(charSlot)]);
            }
          }
