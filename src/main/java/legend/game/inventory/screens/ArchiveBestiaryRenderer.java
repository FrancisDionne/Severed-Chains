...
public class ArchiveBestiaryRenderer {
  ...
  private void loadEntries() {
    ...
    this.addEntry(257, -1, null, "Seles", "Southern Serdio", "A rank-and-file knight in the service of Sandora.\nUses a combination of ranged knives and sword attacks.");
    this.addEntry(256, -1, null, "Seles", "Southern Serdio", "Commander lingering near Seles after it was raided by Sandora.\nHas a basic attack, combo slash, and items at their disposal.");
    this.addEntry(21, -1, null, "Forest", "Southern Serdio", "A cocky bird. Will slash with talons and crow at its enemies.");
    this.addEntry(24, -1, null, "Forest", "Southern Serdio", "A crazed rodent in the Forest. Will often bite.\nAlso has a strange \"Chisel\" attack.");
    this.addEntry(8, -1, null, "Forest", "Southern Serdio", "Strong fighter in the Prairie.\nSeems weak, but does very high damage\nwhen at low health.");
    this.addEntry(38, -1, null, "Forest", "Southern Serdio", "The most durable creature in the Forest. High physical defense.\nWill snap its branches to attack, as well as Pellet.");
    this.addEntry(134, -1, null, "Hellena Prison", "Southern Serdio", "");
    this.addEntry(261, 1, null, "Hellena Prison", "Southern Serdio", "Age: 48\nHeight: 190 cm / 6'3\"\n\nHated by his own country, Fruegel is relegated to lording\nover Hellena Prison. A vain pleasure-seeker adorned with decorations. His pets Guftas and Rodriguez are his only friends.\n\nCombat: club bash, body slam, boulder throw, call allies.");
    ...
    this.addEntry(0, -1, null, "Prairie", "Southern Serdio", "A strong creature,featuring high physical stats\nand Power Up. Weaker to magic.");
    ...
    this.addEntry(138, -1, null, "Endiness", "Limestone Cave - Bale", "");
    this.addEntry(130, -1, null, "Hoax", "Northern Serdio", "");
    this.addEntry(102, 1, null, "Hoax", "Northern Serdio", "");
    this.addEntry(265, -1, null, "Hoax", "Northern Serdio", "");
    ...
    this.addEntry(88, -1, "Man-Eating Bud", "Dragon's Nest", "Southern Serdio", "");
    ...
    this.addEntry(87, -1, null, "Endiness", "Dragon's Nest - Lohan", "");
    ...
    this.addEntry(42, -1, null, "Endiness / Moon", "Road Near Kazas", "");
    ...
    this.addEntry(274, -1, null, "Barrens", "Tiberoa", "");
    this.addEntry(136, -1, null, "Endiness", "Barrens - Home of Gigantos", "");
    ...
    this.addEntry(300, 1, null, "Giganto Home", "Tiberoa", "");
    ...
    this.addEntry(341, 4, null, "Phantom Ship", "Illisa Bay", "");
    ...
    this.addEntry(124, -1, null, "Endiness", "Undersea Cavern - Fueno", "");
    this.addEntry(137, -1, null, "Endiness", "Furni - Deningrad", "");
    ...
    this.addEntry(316, 1, "Wounded Super Virage", "Kadessa", "Mille Seseau", "");
    ...
    this.addEntry(3, -1, null, "Death Frontier", "Death Frontier", "Physical attacker often accompanied by other\ncreatures. Has a special sand attack.");
    this.addEntry(119, -1, null, "Death Frontier", "Death Frontier", "");
    this.addEntry(61, -1, null, "Death Frontier", "Death Frontier", "");
    this.addEntry(139, -1, null, "Endiness", "Death Frontier - Ulara", "");
    this.addEntry(54, -1, null, "Endiness", "Fletz - Rouge", "");
    ...
    this.addEntry(373, -1, null, "Moon", "Gloriano", "");
    this.addEntry(375, -1, null, "Moon", "Gloriano", "");
