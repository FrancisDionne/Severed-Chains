...
public class ArchiveBestiaryRenderer {
  ...
  private void loadEntries() {
    ...
    this.addEntry(262, 1, null, "Hellena Prison", "Southern Serdio", "");
    ...
    this.addEntry(268, 1, null, "Black Castle", "Southern Serdio", "");
    this.addEntry(269, 1, null, "Lohan", "Southern Serdio", "");
    this.addEntry(270, 1, "Lloyd (Wingly)", "Flanvel Tower", "Mille Seseau", "");
    ...
    this.addEntry(294, 1, null, "Undersea Cavern", "Illisa Bay", "");
    ...
    this.addEntry(308, 1, "Virage A", "Villude Volcano", "Southern Serdio", "");
    this.addEntry(311, 1, "Virage B", "Valley of Corrupted Gravity", "Tiberoa", "");
    this.addEntry(316, 1, "Virage S ", "Moon", "Gloriano", "");
    ...
    this.addEntry(349, 1, "Polter", "Snowfield", "Gloriano", "");
