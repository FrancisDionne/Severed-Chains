...
public class BestiaryScreen extends MenuScreen {
  ...
  private static class BestiaryEntry {
    ...
    public BestiaryEntry(final BestiaryScreen bestiary, final int charId, final int subEntryParentId, final int maxKill, @Nullable final String altName, @Nullable final String listName, final String map, final String region, final String lore) {
      this.charId = charId;
  ...
  private void loadEntries() {
    ...
    this.addEntry(257, -1, 4, null, null, "Seles", "Southern Serdio", "A rank-and-file knight in the service of Sandora.\nUses a combination of ranged knives and sword attacks.");
    this.addEntry(256, -1, 1, null, null, "Seles", "Southern Serdio", "Commander lingering near Seles after it was raided by Sandora.\nHas a basic attack, combo slash, and items at their disposal.");
    this.addEntry(21, -1, -1, null, null, "Forest", "Southern Serdio", "A cocky bird. Will slash with talons and crow at its enemies.");
    this.addEntry(24, -1, -1, null, null, "Forest", "Southern Serdio", "A crazed rodent in the Forest. Will often bite.\nAlso has a strange \"Chisel\" attack.");
    this.addEntry(8, -1, -1, null, null, "Forest", "Southern Serdio", "Strong fighter in the Prairie.\nSeems weak, but does very high damage\nwhen at low health.");
    this.addEntry(38, -1, -1, null, null, "Forest", "Southern Serdio", "The most durable creature in the Forest. High physical defense.\nWill snap its branches to attack, as well as Pellet.");
    this.addEntry(134, -1, -1, null, null, "Hellena Prison", "Southern Serdio", "The standard-issue guards of Hellena Prison. They use a long mace in\ncombat, and also carry magical attack items. Their job is to patrol\nthe prison and keep it secure, ensuring no-one escapes.");
    this.addEntry(261, -1, 1, null, null, "Hellena Prison", "Southern Serdio", "Age: 48\nHeight: 190 cm / 6'3\"\n\nHated by his own country, Fruegel is relegated to lording\nover Hellena Prison. A vain pleasure-seeker adorned with decorations. \nHis pets Guftas and Rodriguez are his only friends.\n\nCombat: club bash, body slam, boulder throw, call allies.");
    this.addEntry(259, 261, -1, null, null, "Hellena Prison", "Southern Serdio", "The standard-issue guards of Hellena Prison. They use a long mace in\ncombat, and also carry magical attack items. Their job is to patrol\nthe prison and keep it secure, ensuring no-one escapes.");
    this.addEntry(260, 261, -1, null, null, "Hellena Prison", "Southern Serdio", "The Senior Warden is stronger and more deadly. They wield\ndouble-edged spears and carry magic attack items. \n\nThe Senior Warden also has access to Power Up. This makes them\nharder to defeat, but it can also make their magical attack deadly.");
    this.addEntry(59, -1, -1, null, null, "Prairie", "Southern Serdio", "bzzzzzt!");
    this.addEntry(0, -1, -1, null, null, "Prairie", "Southern Serdio", "A strong creature,featuring high physical stats\nand Power Up. Weaker to magic.");
    this.addEntry(45, -1, -1, null, null, "Prairie", "Southern Serdio", "");
    this.addEntry(27, -1, -1, null, null, "Prairie", "Southern Serdio", "Notable for its long proboscis and large ears. it's mostly harmless.\nHowever, when its health is low it will suck blood to restore itself.");
    this.addEntry(13, -1, -1, null, null, "Limestone Cave", "Northern Serdio", "");
    this.addEntry(94, -1, -1, null, null, "Limestone Cave", "Northern Serdio", "");
    this.addEntry(46, -1, -1, null, null, "Limestone Cave", "Northern Serdio", "A common bat residing in the Limestone Cave. Although very weak,\nits special ability can confuse people into attacking themselves\nor their friends.");
    this.addEntry(104, -1, -1, null, null, "Limestone Cave", "Northern Serdio", "A living ooze, the Slime's standard attack can render enemies unable to\nattack in return. Its special ability deals increased damage.");
    //this.addEntry(148, -1, -1, null, null, "Dragon's Nest", "Southern Serdio", "Unknown variant - pending investigation");
    this.addEntry(64, -1, -1, null, null, "Limestone Cave", "Northern Serdio", "The Ugly Balloon is a creature of the Limestone Cave. It can fly at high\nspeeds. Though it has low defense and attack, it can poison its enemies\nfor high damage over time.");
    this.addEntry(332, -1, 1, null, null, "Limestone Cave", "Northern Serdio", "A large snake-like creature, Urobolus is the guardian of Limestone Cave.\nIt has strong physical attacks and can inflict poison frequently. \nPeriodically it will retreat to a high place, avoiding melee attacks.");
    ...
    this.addEntry(28, -1, -1, null, null, "Marshland", "Northern Serdio", "");
    this.addEntry(4, -1, -1, null, null, "Marshland", "Northern Serdio", "");
    this.addEntry(131, -1, -1, null, null, "Marshland", "Northern Serdio", "");
    this.addEntry(132, -1, -1, null, null, "Marshland", "Northern Serdio", "");
    this.addEntry(135, -1, 1, null, null, "Marshland", "Northern Serdio", "");
    this.addEntry(33, -1, -1, null, null, "Villude Volcano", "Southern Serdio", "");
    //this.addEntry(150, -1, -1, null, null, "Villude Volcano", "Southern Serdio", "");
    this.addEntry(74, -1, -1, null, null, "Villude Volcano", "Southern Serdio", "");
    //this.addEntry(157, -1, -1, null, null, "Villude Volcano", "Southern Serdio", "");
    this.addEntry(100, -1, -1, null, null, "Villude Volcano", "Southern Serdio", "");
    //this.addEntry(146, -1, -1, null, null, "Villude Volcano", "Southern Serdio", "");
    this.addEntry(92, -1, -1, null, null, "Villude Volcano", "Southern Serdio", "A large creature with its back constantly ablaze. The Salamander's\nbasic attack can stun enemies, which becomes dangerous when it\nattacks the same target multiple times.");
    this.addEntry(308, -1, 1, "Wounded Virage (Head)", "Wounded Virage", "Villude Volcano", "Southern Serdio", "A relic of the Dragon Campaign, this Virage was seemingly petrified\nwithin the Volcano for millenia. It activates to attack Dart's party.\n\nThis Virage is not at full strength. It is clearly damaged:\nmissing one arm, both legs, and more. Despite this, it is still deadly.\nThis Virage can inflict an assortment of status ailments, and uses a\nstaggeringly powerful beam laser.");
    this.addEntry(309, 308, -1, "Wounded Virage (Body)", null, "Villude Volcano", "Southern Serdio", "");
    this.addEntry(310, 308, -1, "Wounded Virage (Arm)", null, "Villude Volcano", "Southern Serdio", "");
    this.addEntry(333, -1, 1, null, null, "Villude Volcano", "Southern Serdio", "An elemental creature that patrols the volcano. Fire Bird may pursue\npassersby who attempt to traverse the molten crags. \n\nMost of its abilities have an area of effect, and are of the Fire element.\n\nAlso known as Piton.");
    this.addEntry(334, 333, -1, null, null, "Villude Volcano", "Southern Serdio", "An elemental creature that patrols the volcano. Fire Bird may pursue\npassersby who attempt to traverse the molten crags. \n\nMost of its abilities have an area of effect, and are of the Fire element.\n\nAlso known as Piton.");
    this.addEntry(19, -1, -1, null, null, "Dragon's Nest", "Southern Serdio", "");
    this.addEntry(88, -1, -1, "Man-Eating Bud", null, "Dragon's Nest", "Southern Serdio", "");
    this.addEntry(90, -1, -1, null, null, "Dragon's Nest", "Southern Serdio", "");
    this.addEntry(35, -1, -1, null, null, "Dragon's Nest", "Southern Serdio", "");
    this.addEntry(115, -1, -1, null, null, "Dragon's Nest", "Southern Serdio", "");
    this.addEntry(287, -1, 1, null, null, "Dragon's Nest", "Southern Serdio", "");
    this.addEntry(275, -1, 1, null, null, "Dragon's Nest", "Southern Serdio", "");
    this.addEntry(87, -1, 1, null, null, "Endiness", "Dragon's Nest <-> Lohan", "");
    this.addEntry(302, -1, 1, null, null, "Lohan", "Southern Serdio", "");
    this.addEntry(303, -1, 1, null, null, "Lohan", "Southern Serdio", "");
    this.addEntry(304, -1, 1, null, null, "Lohan", "Southern Serdio", "");
    this.addEntry(305, -1, 1, null, null, "Lohan", "Southern Serdio", "");
    this.addEntry(269, -1, -2, null, null, "Lohan", "Southern Serdio", "");
    this.addEntry(66, -1, -1, null, null, "Shirley's Shrine", "Southern Serdio", "");
    this.addEntry(58, -1, -1, null, null, "Shirley's Shrine", "Southern Serdio", "");
    this.addEntry(55, -1, -1, null, null, "Shirley's Shrine", "Southern Serdio", "");
    this.addEntry(107, -1, -1, null, null, "Shirley's Shrine", "Southern Serdio", "");
    this.addEntry(15, -1, -1, null, null, "Shirley's Shrine", "Southern Serdio", "");
    this.addEntry(325, -1, 1, null, null, "Shirley's Shrine", "Southern Serdio", "");
    this.addEntry(326, 325, -1, null, null, "Shirley's Shrine", "Southern Serdio", "");
    this.addEntry(327, 325, -1, null, null, "Shirley's Shrine", "Southern Serdio", "");
    this.addEntry(288, -1, 1, null, null, "Shirley's Shrine", "Southern Serdio", "");
    this.addEntry(105, -1, 4, null, null, "Hellena Prison", "Southern Serdio", "");
    this.addEntry(129, -1, -1, null, null, "Hellena Prison", "Southern Serdio", "");
    ...
    this.addEntry(26, -1, -1, null, null, "Barrens", "Tiberoa", "");
    this.addEntry(69, -1, -1, null, null, "Barrens", "Tiberoa", "");
    this.addEntry(1, -1, -1, null, null, "Barrens", "Tiberoa", "Decent physical attacker with good defense.\nWeaker to magic.");
    this.addEntry(108, -1, -1, null, null, "Barrens", "Tiberoa", "");
    this.addEntry(299, -1, 1, null, null, "Barrens", "Tiberoa", "");
    this.addEntry(274, 299, -1, null, null, "Barrens", "Tiberoa", "");
    this.addEntry(136, -1, 1, null, null, "Endiness", "Barrens <-> Home of Gigantos", "");
    this.addEntry(16, -1, -1, null, null, "Valley of Corrupted Gravity", "Tiberoa", "");
    this.addEntry(52, -1, -1, null, null, "Valley of Corrupted Gravity", "Tiberoa", "");
    this.addEntry(106, -1, -1, null, null, "Valley of Corrupted Gravity", "Tiberoa", "");
    this.addEntry(29, -1, -1, null, null, "Valley of Corrupted Gravity", "Tiberoa", "");
    this.addEntry(14, -1, -1, null, null, "Valley of Corrupted Gravity", "Tiberoa", "");
    this.addEntry(311, -1, 1, "Virage (Head)", "Virage", "Valley of Corrupted Gravity", "Tiberoa", "A relic of the Dragon Campaign, this Virage laid dormant in the Valley\nfollowing a magic-intensive battle between Winglies and Humans.\n\nUnlike the one found in Serdio, this Virage is at full strength. It has all\nlimbs intact, and has many more abilities at its disposal. It can stomp\nwith its legs, conjure an ethereal energy wave, and can kill someone\nby smashing them into the central green energy cluster on its head.");
    this.addEntry(313, 311, -1, "Virage (Body)", null, "Valley of Corrupted Gravity", "Tiberoa", "");
    this.addEntry(312, 311, -1, "Virage (Arm)", null, "Valley of Corrupted Gravity", "Tiberoa", "");
    this.addEntry(79, -1, -1, null, null, "Giganto Home", "Tiberoa", "");
    this.addEntry(83, -1, -1, null, null, "Giganto Home", "Tiberoa", "");
    ...
    this.addEntry(86, -1, -1, null, null, "Phantom Ship", "Illisa Bay", "");
    //this.addEntry(154, -1, -1, null, null, "Phantom Ship", "Illisa Bay", "");
    //this.addEntry(155, -1, -1, null, null, "Phantom Ship", "Illisa Bay", "");
    this.addEntry(70, -1, 4, null, null, "Phantom Ship", "Illisa Bay", "");
    this.addEntry(340, -1, 1, null, null, "Phantom Ship", "Illisa Bay", "");
    this.addEntry(341, -1, 1, null, null, "Phantom Ship", "Illisa Bay", "");
    this.addEntry(12, -1, -1, null, null, "Undersea Cavern", "Illisa Bay", "");
    this.addEntry(23, -1, -1, null, null, "Undersea Cavern", "Illisa Bay", "");
    this.addEntry(91, -1, -1, null, null, "Undersea Cavern", "Illisa Bay", "");
    this.addEntry(76, -1, -1, null, null, "Undersea Cavern", "Illisa Bay", "");
    this.addEntry(110, -1, -1, null, null, "Undersea Cavern", "Illisa Bay", "");
    this.addEntry(294, -1, 1, "Lenus (Dragoon)", null, "Undersea Cavern", "Illisa Bay", "");
    this.addEntry(279, -1, 1, null, null, "Undersea Cavern", "Illisa Bay", "");
    this.addEntry(124, -1, 1, null, null, "Endiness", "Undersea Cavern <-> Fueno", "");
    this.addEntry(137, -1, 1, null, null, "Endiness", "Furni <-> Deningrad", "");
    this.addEntry(95, -1, -1, null, null, "Evergreen Forest", "Mille Seseau", "");
    this.addEntry(53, -1, -1, null, null, "Evergreen Forest", "Mille Seseau", "");
    this.addEntry(73, -1, -1, null, null, "Evergreen Forest", "Mille Seseau", "");
    this.addEntry(117, -1, -1, null, null, "Evergreen Forest", "Mille Seseau", "");
    this.addEntry(51, -1, -1, null, null, "Evergreen Forest", "Mille Seseau", "");
    this.addEntry(343, -1, 1, null, null, "Evergreen Forest", "Mille Seseau", "");
    this.addEntry(43, -1, -1, null, null, "Kadessa", "Mille Seseau", "");
    this.addEntry(30, -1, -1, null, null, "Kadessa", "Mille Seseau", "");
    this.addEntry(44, -1, -1, null, null, "Kadessa", "Mille Seseau", "");
    this.addEntry(111, -1, -1, null, null, "Kadessa", "Mille Seseau", "");
    this.addEntry(2, -1, -1, null, null, "Kadessa", "Mille Seseau", "");
    this.addEntry(316, -1, 1, "Wounded Super Virage (Head)", "Wounded Super Virage", "Kadessa", "Mille Seseau", "A relic of the Dragon Campaign, this is a more powerful type of Virage.\nIt was nearly defeated by Kanzas during the final battle of the Dragon\nCampaign, at the Wingly capital Kadessa.\n\nThis Virage barely survived, but is still formiddable. It has a variety of\nattacks, and will self-destruct if not defeated quickly.");
    this.addEntry(317, 316, -1, "Wounded Super Virage (Body)", null, "Kadessa", "Mille Seseau", "");
    this.addEntry(318, 316, -1, "Wounded Super Virage (Arm)", null, "Kadessa", "Mille Seseau", "");
    this.addEntry(335, -1, 1, null, null, "Kadessa", "Mille Seseau", "");
    this.addEntry(96, -1, -1, null, null, "Mortal Dragon Mountain", "Mille Seseau", "");
    this.addEntry(6, -1, -1, null, null, "Mortal Dragon Mountain", "Mille Seseau", "");
    this.addEntry(113, -1, -1, null, null, "Mortal Dragon Mountain", "Mille Seseau", "");
    this.addEntry(112, -1, -1, null, null, "Mortal Dragon Mountain", "Mille Seseau", "");
    this.addEntry(37, -1, -1, null, null, "Mortal Dragon Mountain", "Mille Seseau", "");
    this.addEntry(283, -1, 1, null, null, "Mortal Dragon Mountain", "Mille Seseau", "");
    this.addEntry(284, 283, -1, null, null, "Mortal Dragon Mountain", "Mille Seseau", "");
    this.addEntry(285, 283, -1, null, null, "Mortal Dragon Mountain", "Mille Seseau", "");
    this.addEntry(32, -1, -1, null, null, "Kashua Glacier", "Mille Seseau", "");
    this.addEntry(114, -1, -1, null, null, "Kashua Glacier", "Mille Seseau", "");
    this.addEntry(5, -1, -1, null, null, "Kashua Glacier", "Mille Seseau", "");
    ...
    this.addEntry(25, -1, -1, null, null, "Flanvel Tower", "Mille Seseau", "");
    this.addEntry(56, -1, -1, null, null, "Flanvel Tower", "Mille Seseau", "");
    //this.addEntry(144, -1, -1, null, null, "Flanvel Tower", "Mille Seseau", "");
    this.addEntry(49, -1, -1, null, null, "Flanvel Tower", "Mille Seseau", "");
    this.addEntry(344, -1, 1, null, null, "Flanvel Tower", "Mille Seseau", "");
    this.addEntry(31, -1, -1, null, null, "Snowfield", "Gloriano", "");
    this.addEntry(116, -1, -1, null, null, "Snowfield", "Gloriano", "");
    ...
    this.addEntry(41, -1, -1, null, null, "Vellweb", "Gloriano", "");
    this.addEntry(63, -1, -1, null, null, "Vellweb", "Gloriano", "");
    this.addEntry(89, -1, -1, null, null, "Death Frontier", "Death Frontier", "");
    this.addEntry(36, -1, -1, null, null, "Death Frontier", "Death Frontier", "");
    this.addEntry(3, -1, -1, null, null, "Death Frontier", "Death Frontier", "Physical attacker often accompanied by other\ncreatures. Has a special sand attack.");
    this.addEntry(119, -1, -1, null, null, "Death Frontier", "Death Frontier", "");
    this.addEntry(61, -1, -1, null, null, "Death Frontier", "Death Frontier", "");
    this.addEntry(139, -1, 1, null, null, "Endiness", "Death Frontier <-> Ulara", "");
    this.addEntry(54, -1, 1, null, null, "Endiness", "Fletz <-> Rouge", "");
    this.addEntry(121, -1, -1, null, null, "Aglis", "Broken Islands", "");
    this.addEntry(60, -1, -1, null, null, "Aglis", "Broken Islands", "");
    this.addEntry(9, -1, -1, null, null, "Aglis", "Broken Islands", "");
    this.addEntry(75, -1, -1, null, null, "Aglis", "Broken Islands", "");
    this.addEntry(72, -1, -1, null, null, "Aglis", "Broken Islands", "");
    this.addEntry(365, -1, 1, null, null, "Aglis", "Broken Islands", "");
    this.addEntry(366, 365, -1, null, null, "Aglis", "Broken Islands", "");
    this.addEntry(118, -1, -1, null, null, "Zenebatos", "Gloriano", "");
    this.addEntry(40, -1, -1, null, null, "Zenebatos", "Gloriano", "");
    this.addEntry(97, -1, -1, null, null, "Zenebatos", "Gloriano", "");
    ...
    this.addEntry(296, -1, 1, null, null, "Vellweb", "Gloriano", "");
    //this.addEntry(101, -1, -1, null, null, "Mayfil", "Gloriano", "");
    this.addEntry(152, -1, -1, null, null, "Mayfil", "Gloriano", "");
    this.addEntry(125, -1, -1, null, null, "Mayfil", "Gloriano", "");
    this.addEntry(10, -1, -1, null, null, "Mayfil", "Gloriano", "");
    this.addEntry(78, -1, -1, null, null, "Mayfil", "Gloriano", "");
    this.addEntry(84, -1, -1, null, null, "Mayfil", "Gloriano", "");
    this.addEntry(354, -1, 1, "Feyrbrand Spirit", null, "Mayfil", "Gloriano", "");
    this.addEntry(353, -1, 1, "Regole Spirit", null, "Mayfil", "Gloriano", "");
    this.addEntry(352, -1, 1, "Divine Dragon Spirit", null, "Mayfil", "Gloriano", "");
    this.addEntry(363, -1, 1, null, null, "Mayfil", "Gloriano", "");
    this.addEntry(364, 363, -1, null, null, "Mayfil", "Gloriano", "");
    this.addEntry(98, -1, -1, null, null, "Divine Tree", "Gloriano", "");
    this.addEntry(7, -1, -1, null, null, "Divine Tree", "Gloriano", "");
    this.addEntry(126, -1, -1, null, null, "Divine Tree", "Gloriano", "");
    this.addEntry(77, -1, -1, null, null, "Divine Tree", "Gloriano", "");
    this.addEntry(62, -1, -1, null, null, "Divine Tree", "Gloriano", "");
    this.addEntry(370, -1, 1, null, null, "Divine Tree", "Gloriano", "");
    this.addEntry(368, 370, -1, null, null, "Divine Tree", "Gloriano", "");
    this.addEntry(369, 370, -1, null, null, "Divine Tree", "Gloriano", "");
    this.addEntry(123, -1, -1, null, null, "Moon", "Gloriano", "");
    this.addEntry(34, -1, -1, null, null, "Moon", "Gloriano", "");
    this.addEntry(81, -1, -1, null, null, "Moon", "Gloriano", "");
    this.addEntry(127, -1, -1, null, null, "Moon", "Gloriano", "");
    this.addEntry(128, -1, -1, null, null, "Moon", "Gloriano", "");
    this.addEntry(120, -1, -1, null, null, "Moon", "Gloriano", "");
    this.addEntry(71, -1, -1, null, null, "Moon", "Gloriano", "");
    this.addEntry(93, -1, -1, null, null, "Moon", "Gloriano", "");
    this.addEntry(371, -1, 1, null, null, "Moon", "Gloriano", "");
