...
public class MasterAddition extends SimpleAddition {
  ...
  @Override
  public boolean isUnlocked(final GameState52c gameState, final CharacterData2c charData, final CharacterAdditionStats additionStats) {
    return (charData.partyFlags_04 & 0x40) != 0;
  }

  @Override
  public void loadAnimations(final GameState52c gameState, final CharacterData2c charData, final CharacterAdditionStats additionStats, final Consumer<List<FileData>> onLoad) {
