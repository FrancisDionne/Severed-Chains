...
public abstract class Addition extends RegistryEntry {
  ...
  public abstract int getHitCount(final GameState52c gameState, final CharacterData2c charData, final CharacterAdditionStats additionStats);
  public abstract AdditionHitProperties10 getHit(final GameState52c gameState, final CharacterData2c charData, final CharacterAdditionStats additionStats, final int index);

  public abstract void loadAnimations(final GameState52c gameState, final CharacterData2c charData, final CharacterAdditionStats additionStats, Consumer<List<FileData>> onLoad);
}
